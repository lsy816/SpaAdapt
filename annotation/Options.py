...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='starmap', help='name of the experiment')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--input_dim', type=int, default=150, help='Dim of input, using HVG')
...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--sc_data', type=str, default='/home/lsy/data/MPFC_starmap/GSE124952_sc.h5ad',help='source scRNA-seq dataset, h5ad format.')
        parser.add_argument('--st_data', type=str, default='/home/lsy/data/MPFC_starmap/BZ5.h5ad',help='target spatial transcriptomic dataset, h5ad format.')

        parser.add_argument('--neighbor_per_batch', type=int, default=500, help='max neighbor nodes in per batch')
        ...
        parser.add_argument('--classes', type=int, default=5, help='number of classes for CLS branch')
        ...
        parser.add_argument('--cells_per_batch', type=int, default=180, help='random sampling number of cells per epoch')

        parser.add_argument('--lambda_F', type=float, default=10, help='Weight of reconstruction loss.')
        parser.add_argument('--lambda_CA', type=float, default=0.2, help='Weight for class consistency loss.')
        parser.add_argument('--lambda_C', type=float, default=5, help='Weight of classification loss.')
        parser.add_argument('--lambda_Dep', type=float, default=1, help='Weight of disentanglement loss.')
        parser.add_argument('--lambda_MMD', type=float, default=1, help='Weight of MMD loss.')
